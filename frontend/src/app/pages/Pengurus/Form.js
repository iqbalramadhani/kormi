...
export function FormPengurus(props) {
  const [jabatanList, setJabatanList] = useState([]);

  const handleChanges = async (e, name = null) => {
    let property = name ? name : e ? (e.target ? (e.target.name ? e.target.name : '') : '') : '';
      ...
      <div className='col-md-12'>
        <Form.Group as={Row} controlId='name'>
          ...
          <Col sm={10}>
            <Form.Control
              ...
              name='name'
            />
            <Form.Control.Feedback type='invalid'>Mohon Masukkan Nama</Form.Control.Feedback>
        ...
        <Form.Group as={Row} controlId='jabatan_id'>
          ...
          <Col sm={10}>
            ...
            <Form.Control.Feedback type='invalid'>Pilih Jabatan</Form.Control.Feedback>
          </Col>
        </Form.Group>
      </div>
    </div>

...
export function StatusOrganizationListPage() {
    ...
    if (row) {
      return (
        <div className="d-flex">
          <Link
            to={`/status-organization/${row.id}/update`}
  ...
  return (
    <Card>
      <CardHeader title="Data Status Anggota">
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="d-flex mb-6 float-right">
              ...
              <Link className="btn btn-success mr-2" to="/status-organization/create">
                Tambah
              </Link>
            </div>
          </div>
...
export default StatusOrganizationListPage;

...
import TableMainOrganization from './TableMainOrganization'
...
function CardTableMainOrganization(props) {
        ...
        <div className='row'>
          ...
          <div className="col-md-3">
            <div className="d-flex mb-6 float-right">
              ...
              <Link className="btn btn-success mr-2" to="/add/main-organization">
                Tambah
              </Link>
            </div>
          </div>
        </div>
        <TableMainOrganization handleSelectData={handleSelectData} />
      </CardBody>
    </Card>
    )
}

export default CardTableMainOrganization

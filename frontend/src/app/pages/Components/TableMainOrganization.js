...
function TableMainOrganization(props) {
    ...
    const actionFormatter = (cell, row) => {
        return (
            <div className='d-flex'>
                ...
                <span>
                <Link to={`/edit/main-organization?id=${row.id}`}>
        ...
        <>
            <PaginationProvider pagination={ paginationFactory(paginateOption) } >
            {
                ({ paginationProps, paginationTableProps }) => {
                    return (
                        <div>
                            <BootstrapTable keyField='id' data={dataList} columns={columns} selectRow={selectRow} remote {...paginationTableProps} />
                            <div className='row align-items-center mt-5'>
                                ...
                                <div className='col-md-6'>
                                    <div className='d-flex float-right'>
                                        ...
                                        <PaginationListStandalone {...paginationProps} onPageChange={(e) => handlePageChange(e)} />
                                    </div>
                                </div>
                            </div>
                        </div>

...
import TableOrganizationStatus from './TableOrganizationStatus'
...
function CardTableOrganizationStatus() {
        ...
        <div className="col-md-4">
          ...
          <div className="col-md-3">
            <div className="d-flex mb-6 float-right">
              ...
              <Link className="btn btn-success mr-2" to="/add/status-organization">
                Tambah
              </Link>
            </div>
          </div>
        </div>
        <TableOrganizationStatus handleSelectData={handleSelectData} />
      </CardBody>
    </Card>
    )
}

export default CardTableOrganizationStatus

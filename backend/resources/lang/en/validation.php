...
return [
    ...
    */
    ...
    'digits_between'       => 'Isian :attribute berupa angka, antara :min hingga :max.',
    ...
    */
    ...
    'attributes' => [
        ...
        "city" => "kota",
        "cities_id" => "kota",
        'organitation_status_id' => "status organisasi",
        "parent" => "induk organisasi",
        "phone_number" => "No. tlp",
        "province" => "provinsi",
        "last_date_sk" => "Tanggal berakhir sk"
    ],
    'dates' => [
        'now' => 'sekarang'
    ]

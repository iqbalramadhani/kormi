...
class PengurusController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $pengurus = Pengurus::with('jabatan')->where('organitation_parent_id', $admin->organitation_parent_id)
...
//        $administratorId = $request->administrator_id;
    ...
    public function store(Request $request)
    {
        ...
        $pengurus->administrator_id = $request->get('administrator_id');
        $pengurus->organitation_parent_id = $admin->organitation_parent_id;
        $pengurus->save();
